...
#URL
CL_engineer = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=Data%2BEngineer&location=Chile&geoId=104621616&trk=public_jobs_jobs-search-bar_search-submit&start='
CL_analyst = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=Data%2BAnalyst&location=Chile&geoId=104621616&trk=public_jobs_jobs-search-bar_search-submit&start='
CL_science = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=Data%2BScience&location=Chile&geoId=104621616&trk=public_jobs_jobs-search-bar_search-submit&start='
CL = [CL_analyst,CL_engineer,CL_science]
...
def scraping():
    ...
    df.to_csv('gs://proyecto-final-data/Scraping/scrapingCL.csv',index=False)
