...
#URL
CO_engineer = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=Data%2BEngineer&location=Colombia&geoId=100876405&trk=public_jobs_jobs-search-bar_search-submit&start='
CO_analyst = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=Data%2BAnalyst&location=Colombia&geoId=100876405&trk=public_jobs_jobs-search-bar_search-submit&start='
CO_science = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=Data%2BScientist&location=Colombia&geoId=100876405&trk=public_jobs_jobs-search-bar_search-submit&start='
CO = [CO_analyst,CO_engineer,CO_science]
...
def scraping():
    ...
    df.to_csv('gs://proyecto-final-data/Scraping/scrapingCO.csv',index=False)
